...
from pinax.lms.activities.base import Activity, Quiz, TwoChoiceQuiz, TwoChoiceWithAnswersQuiz, LikertQuiz, TwoChoiceLikertWithAnswersQuiz
...
class GreekKeyboard(Activity):
    ...
    def handle_request(self, request):
        ...
        if request.method == "POST":
            if request.is_ajax():
                l = json.loads(request.POST.get("log"))
                question = l[0]
                answers = l[1:]
