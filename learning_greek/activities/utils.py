...
nouns = load_file("raw_course_data/nouns.txt", ["chapter", "citation-form", "tags", "gloss"])
adjectives = load_file("raw_course_data/adjectives.txt", ["chapter", "citation-form", "gloss"])
others = load_file("raw_course_data/other.txt", ["chapter", "citation-form", "gloss"])
articles = load_file("raw_course_data/article.txt", ["cng", "form"])
